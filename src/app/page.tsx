...
const PlanetariumLayer = dynamic(() => import('@/components/PlanetariumLayer'), { ssr: false });
  ...
  return (
    <main className="fixed inset-0 w-full h-full bg-[var(--bg-void)] overflow-hidden">
      ...
      <ErrorBoundary name="Map">
        <OsirisMap 
          data={data} 
          activeLayers={activeLayers as unknown as Record<string, boolean>} 
      ...
      {/* ── PLANETARIUM OVERLAY ── */}
      {activeLayers.planetarium && (
        <PlanetariumLayer
          mapCenter={mapCenter}
          opacity={activeLayers.planetarium_opacity ?? 80}
        />
      )}
      ...
      {showLayers && !isMobile && <LayerPanel data={data} activeLayers={activeLayers as unknown as Record<string, boolean>} setActiveLayers={setActiveLayers} />}
                ...
                <div className="px-3 pb-3">
                  ...
                  {mobilePanel === 'layers' && (
                    <>
                      ...
                      <LayerPanel data={data} activeLayers={activeLayers as unknown as Record<string, boolean>} setActiveLayers={setActiveLayers} isMobile={true} />
                      <div className="mt-2">
                  ...
                  {mobilePanel === 'search' && (
                    <div className="space-y-2">
                      ...
                      <SharePanel mapView={mapView} activeLayers={activeLayers as unknown as Record<string, boolean>} mouseCoords={null} />
                    </div>
                  )}
                  {mobilePanel === 'recon' && (
                    <div className="space-y-2">
